...
const MOCKUP_SCREENS = [
  { src: "/trendify-home.png", label: "Home — Browse" },
...
const DESIGN_DECISIONS = [
  {
    ...
    description:
      "Sneaker culture is inherently premium and street-coded. A dark theme with sharp accent colors reflects this, while keeping the UI feeling clean and contemporary — not grungy.",
  },
  {
    icon: Navigation,
    title: "Bottom Navigation Architecture",
    description:
      "All primary actions live within thumb reach. The navigation was designed for one-handed use — the dominant interaction pattern for mobile commerce in East Africa.",
  },
  {
    icon: MousePointerClick,
    title: "Micro-Interaction Led UX (ProtoPie)",
    description:
      "Every tap, swipe, and transition was prototyped with ProtoPie — realistic momentum scrolling, spring animations on product cards, and haptic-like feedback states.",
  },
  {
    icon: Package,
    title: "Delivery-First User Flow",
    description:
      "The product detail screen leads directly into a delivery booking flow — not a generic cart. The buyer knows exactly when their sneakers arrive before they confirm.",
  },
  {
    icon: Layers,
    title: "Component System in Figma",
    description:
      "Built with a structured component library — buttons, cards, tags, and inputs are all reusable components with defined variants, ready for developer handoff.",
  },
  {
    icon: Smartphone,
    title: "Designed for Android & iOS",
    description:
      "Frames designed at standard mobile resolutions with platform-appropriate patterns — respecting Android and iOS conventions while maintaining a unified brand language.",
  },
];
...
const DESIGN_PROCESS = [
  {
    ...
    description: "Studied how sneaker buyers in Nairobi discover and purchase — Instagram DMs, WhatsApp orders, physical markets. The gap was clear: no dedicated, trustworthy mobile-first experience."
  },
  {
    phase: "02",
    title: "User Flow Mapping",
    description: "Mapped the core buyer journey: discover → inspect → select size → checkout → track delivery. Every screen corresponds to one step in this flow with no dead ends."
  },
  {
    phase: "03",
    title: "Brand Identity Design",
    description: "Created the Trendify visual identity — wordmark, color palette, icon system, and typography. Wanted a brand that could sit next to Nike.com and not look out of place."
  },
  {
    phase: "04",
    title: "Figma UI Design",
    description: "Built the full screen set in Figma — Home, Category, Product Detail, Cart, Checkout, Order Tracking, and Profile. All with auto-layout and defined constraints."
  },
  {
    phase: "05",
    title: "ProtoPie Prototyping",
    description: "Brought the design to life with advanced interactions in ProtoPie — swipe gestures, transition physics, and micro-animations that make the prototype feel like a real app."
  },
];

export default function TrendifyCaseStudy() {
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-secondary/30 mb-6">
              ...
              <span className="text-[10px] uppercase tracking-widest font-bold opacity-80">
                Mobile UI/UX Design · Figma · ProtoPie
              </span>
            </div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              A high-fidelity mobile app design for sneaker culture in East Africa — 
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-border bg-secondary/30 text-sm">
              ...
              <span className="text-muted-foreground">Design Complete · Development Phase Next</span>
            </div>
          </motion.div>
              ...
              {MOCKUP_SCREENS.map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${
                    i === activeScreen ? "bg-primary w-6" : "bg-border"
                  }`}
                />
              ))}
            </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            { label: "Status", value: "Design Complete · Open to Build" },
          ].map((item) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start mb-24">
          ...
          <div className="space-y-5 pt-2 md:pt-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Generic e-commerce apps don&apos;t speak this language — they&apos;re built for mass retail, 
            ...
            <p className="text-foreground font-medium leading-relaxed">
              Trendify is the design answer to that gap — a mobile experience built entirely 
        ...
        <div>
          ...
          <blockquote className="border-l-4 border-primary pl-8 py-4 mb-8">
            <p className="text-2xl md:text-3xl font-bold italic leading-snug">
              &quot;Design is strategy made visible. Trendify isn&apos;t just a pretty UI — it&apos;s a 
              documented product strategy for a real market gap.&quot;
            </p>
          </blockquote>
          <p className="text-muted-foreground leading-relaxed max-w-3xl mb-8">
            Most mobile UI projects stop at aesthetics. Trendify goes deeper — every screen 
            ...
            portfolio scroll — it was to build something a development team could pick up and 
