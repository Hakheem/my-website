...
export default function SixpointCaseStudy() {
  return (
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {BEFORE_AFTER.map((side) => (
              ...
              >
                <p
                  className={`text-[10px] uppercase tracking-widest font-bold mb-5 ${
                    side.label === "After" ? "text-primary" : "text-muted-foreground"
                  }`}
                >
                  {side.label}
                </p>
                    ...
                    <li key={item} className="flex items-center gap-3 text-sm">
                      <span
                        className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                          side.label === "After" ? "bg-primary" : "bg-muted-foreground/40"
                        }`}
                      />
                      <span
                        className={
